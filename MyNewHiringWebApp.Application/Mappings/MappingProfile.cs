    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<CandidateCreateDto, Candidate>()
                ...
                .ForMember(dest => dest.CandidateSkills, opt => opt.Ignore()); // skill'leri servisle ekle
                ...
                .ForMember(dest => dest.Skills,
                    opt => opt.MapFrom(src =>
                        src.CandidateSkills == null
                            ? null
                            : src.CandidateSkills.Select(cs => new MyNewHiringWebApp.Application.DTOs.CandidateDtos.CandidateSkillDto
                            {
            ...
            // ---------- CandidateSkill ----------
            // If you have separate CandidateSkill DTOs, map them explicitly:
            CreateMap<CandidateSkillCreateDto, CandidateSkill>().ReverseMap();
            CreateMap<CandidateSkillUpdateDto, CandidateSkill>().ReverseMap();

            // Map domain CandidateSkill -> CandidateSkillDto (from candidate-dedicated DTO namespace)
            // Use fully-qualified target type to avoid ambiguity between namespaces
            ...
            // Also map CandidateSkill -> CandidateDto's inner CandidateSkillDto (if used)
            CreateMap<CandidateSkill, MyNewHiringWebApp.Application.DTOs.CandidateDtos.CandidateSkillDto>()
                .ForMember(d => d.SkillName, opt => opt.MapFrom(s => s.Skill != null ? s.Skill.Name : string.Empty))
                .ForMember(d => d.Level, opt => opt.MapFrom(s => s.Level));
